...
class HabitCRUDTestCase(APITestCase):
    ...
    def test_get_list_reword(self):
        ...
        self.assertEqual(
            ...
            {'count': 1,
             'next': None,
             'previous': None,
             'results': [{'description': '', 'id': self.reword_1.pk, 'name': 'test reword #1', 'user': self.test_user_1.pk}]})
    ...
    def test_get_reword(self):
        ...
        self.assertEqual(
            request.json(),
            {'id': self.reword_1.pk, 'name': 'test reword #1', 'description': '', 'user': self.test_user_1.pk})
